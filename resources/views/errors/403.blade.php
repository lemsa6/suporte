...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-cinza-claro-2 flex items-center justify-center px-4">
        <div class="max-w-2xl w-full text-center">
            ...
            <!-- Título e Descrição -->
            <div class="mb-8">
                <h1 class="text-6xl font-bold text-cinza mb-4">403</h1>
                <h2 class="text-2xl font-semibold text-cinza mb-4">Acesso Negado</h2>
                ...
                <div class="flex items-center justify-center text-cinza-claro">
                    ...
                    <span>Verifique suas permissões</span>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                @auth
                    <x-button variant="outline" size="lg" tag="a" href="{{ route('logout') }}">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    <x-button variant="outline" size="lg" tag="a" href="{{ route('login') }}">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
